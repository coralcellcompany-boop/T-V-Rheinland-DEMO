        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    AssignedClientIdsCsv = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedServices = table.Column<int>(type: "int", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    AramcoCategory = table.Column<int>(type: "int", nullable: true),
                    DefaultStandards = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MsReference = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Annex = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportIssueDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ...
                    LoadTest = table.Column<int>(type: "int", nullable: false),
                    Result = table.Column<int>(type: "int", nullable: false),
                    StickerNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InspectionCertificates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    JobOrderNo = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    ClientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    AssignedInspectorIds = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Swl = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    AramcoCategory = table.Column<int>(type: "int", nullable: true),
                    Location = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "CertificateStateTransitions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CertificateStateTransitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CertificateStateTransitions_InspectionCertificates_CertificateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CertificateStateTransitions_CertificateId",
                table: "CertificateStateTransitions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipment_ClientId_IdNo",
                table: "Equipment",
                columns: new[] { "ClientId", "IdNo" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InspectionCertificates_CertificateNo",
